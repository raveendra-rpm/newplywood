    ...
    <section className="py-16 bg-brand-red text-white">
      <div className="container-shell flex flex-col md:flex-row items-center justify-between gap-8 h-full">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <a href="#contact" className="px-8 py-4 bg-white !text-[#d97706] font-extrabold rounded-md shadow-lg hover:bg-slate-50 transition-all text-lg min-w-[200px] flex items-center justify-center">
            Enquiry Now
          </a>
